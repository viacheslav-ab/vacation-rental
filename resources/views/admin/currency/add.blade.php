                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_currency')}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="code" class="form-control"  placeholder="Code" aria-label="Code" required>
                                            </div>
                                        </div>                                          
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="symbol" class="form-control"  placeholder="Symbol" aria-label="Symbol" required>
                                            </div>
                                        </div>                                          
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" name="rate" class="form-control" step="0.01" placeholder="Rate" aria-label="Rate" required>
                                            </div>
                                        </div>
