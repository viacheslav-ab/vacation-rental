...
<link rel="stylesheet" type="text/css"
    href="{{asset('admin_assets/bower_components/jquery-minicolors/jquery.minicolors.css')}}" />
@endsection
            ...
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    <div class="row">                    
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-hea`der table-card-header">  
                                    <div class="row">
                                        ...
                                        @foreach($themeSettings as $theme)
                                            @if($theme->name=="body_font_size")
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="{{$theme->name}}" value="{{$theme->value}}" class="form-control" aria-label="Theme Data" required>
                                                    </div>
                                                </div> 
                                            @else
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label text-right">{{$theme->name}}<span class="text-danger">*</span></label>
                                                    <div class="col-sm-6">                                            
                                                        <input type="text" name="{{$theme->name}}" value="{{$theme->value}}" class="form-control demo" data-control="saturation" aria-label="Theme Data">
                                                    </div>
                                                </div>
                                            @endif
                                        @endforeach            
...
<script type="text/javascript"
    src="{{asset('admin_assets/bower_components/jquery-minicolors/jquery.minicolors.min.js')}}"></script>
<script>
    $('.demo').each( function() {
