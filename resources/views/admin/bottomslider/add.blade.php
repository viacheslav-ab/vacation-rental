                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_bottom_slider')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="title" class="form-control"  placeholder="Title" aria-label="Bottom Slider Title" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">Description<span class="text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <textarea type="text" name="description" class="form-control" aria-label="Bottom Slider Description" required></textarea>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="Bottom Slider Image" required />
                                            </div>
                                        </div>       
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="order" class="form-control" value="0" placeholder="order" aria-label="Bottom Slider Order" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="status" class="form-control form-control-default required" aria-label="Bottom Slider Status" required>
