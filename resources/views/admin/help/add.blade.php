                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_help')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="question" class="form-control"  placeholder="Question" aria-label="Question" required>
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">                                       
                                                <textarea name="answer" class="summernote" aria-label="Answer"></textarea>
                                            </div>
                                        </div>
