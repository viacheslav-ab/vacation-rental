...
<html lang="en">
   <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, maximum-scale=5">
   ...
   <body>
            ...
            <nav class="navbar header-navbar pcoded-header" header-theme="theme4">
               <div class="navbar-wrapper">
                  <div class="navbar-logo">
                     <a class="mobile-menu" id="mobile-collapse" href="#!" aria-label="Navigation Bar Logo for Mobile Menu">
                        <i class="ti-menu"></i>
                     </a>                       
                     <a href="index-2.html">
                  ...
                  <div class="navbar-container container-fluid">
                     <div>
                        <ul class="nav-left">
                           <li>
                              <div class="sidebar_toggle"><a href="javascript:void(0)" aria-label="Hide the left sidebar"><i class="ti-menu"></i></a></div>
                           </li>                                
                           <li>
                              <a href="#!" onclick="javascript:toggleFullScreen()" aria-label="Full screen">
      ...
      <script type="text/javascript" src="{{asset('admin_assets/bower_components/summernote/dist/summernote-image-attributes/summernote-image-attributes.js')}}"></script>
