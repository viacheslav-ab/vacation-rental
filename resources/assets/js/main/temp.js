...
"/s" != last_part ? headerAutocomplete() : $("#header-search-form-mob").keypress(function(e) {
    ...
    window.cookieconsent.utils.isMobile = function() {
        ...
        position: "bottom",
        content: {
            message: 'In an effort towards providing our users with the utmost transparency, please review our full <a href="' + APP_URL + '/legal/privacy-policy">privacy policy</a> and user data <a href="' + APP_URL + '/legal/terms-of-service">terms of service</a>.<br> This site also uses cookies to ensure you receive the best experience on our site.'
        },
