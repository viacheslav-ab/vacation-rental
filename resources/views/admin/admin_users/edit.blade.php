                        ...
                        <div class="card-block">
                           <form method="POST" action="{{url('admin/edit_admin_user/' . $user->id)}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" name="username" class="form-control" value="{{$user->username}}" aria-label="User Name" required>
                                 </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" name="bio" class="form-control" value="{{$user->bio}}" aria-label="Bio" required>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label class="col-sm-3 col-form-label text-right">Password<span class="text-danger">*</span></label>
                                 <div class="col-sm-6">
                                    <input type="password" name="password" class="form-control" value="" placeholder="Write password..." aria-label="Password">
                                 </div>
                              </div>
