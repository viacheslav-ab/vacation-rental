		...
		<div class="col-12">
			<div id="tos_outside" class="row-space-top-2 chk-box">
				<div class="dis_tb control-group">
					...
					<div class="dis_cell">
						<small>
							{{ trans('messages.login.signup_agree') }} Vacation.rental's <a href="{{URL::to('/')}}/legal/terms-of-service" data-popup="true">{{ trans('messages.login.terms_service') }}</a>, <a href="{{URL::to('/')}}/legal/privacy-policy" data-popup="true">{{ trans('messages.login.privacy_policy') }}</a>.
						</small>
					</div>
				</div>
			</div>
