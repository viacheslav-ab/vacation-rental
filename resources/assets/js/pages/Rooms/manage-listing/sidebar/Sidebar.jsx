...
import { renderSidebarAction } from "../../../../actions/managelisting/renderSidebarAction";
...
class Sidebar extends React.Component {
  ...
  render() {
    console.log(this.state.rooms_step_status, 'Track for sidebar');
              ...
              >
                <div className="row nav-item">
                  <div className="col-sm-12 va-container">
                    ...
                    <div
                      className={
                        this.state.rooms_step_status.calendar == "1"
                          ? "pull-right lang-left-change"
                          : "pull-right lang-left-change hide"
                      }
                    >
        ...
        <div className="publish-actions text-center">
          ...
          <div id="js-publish-button" className="mt-2">
            <div className="not-post-listed text-center">
              ...
              >
              {
                completed_steps == 8 ? <div>You completed all steps</div>: <div> Complete
                <strong className="text-highlight">
                  <span id="steps_count"> {8-completed_steps}</span> steps
                </strong>{" "}
                to list your space.</div>
              }
