                    ...
                    <div className="manage_listing_left">
                     <img src={property_help} alt="property-help" className="col-center" width="75" height="75"/>
                        <div className="amenities_about">
                            ...
                            <p>Please make sure to join our homeowners <a href="https://www.facebook.com/groups/vacation.rentals4U/" target="_blank" rel="noopener">Facebook Group</a> to stay abreast of all updates and improvements.</p>
