                                    ...
                                    <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                        ...
                                        <tbody>
                                            @if(count($data) != 0)
                                                ...
                                                <tr>
                                                    <td>{{$row->id}}</td>                            
                                                    <td><img aria-label="Slider Image" src="{{asset("images/slider/$row->image")}}" style="height:100px"></td>
                                                    <td>{{$row->order}}</td>
                                                    <td>{{$row->status}}</td>                            
                                                    <td class="text-center">
                                                        <a href="{{url( 'admin/edit_slider/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Edit Slider">
                                                            <i class="icofont icofont-edit"></i>
                                                        </a>
                                                        &nbsp;
                                                        <button data-id="{{ $row->id }}" class="btn btn-xs btn-danger delete-btn" aria-label="Edit Slider">
