                                                ...
                                                @if(count($data) != 0)
                                                    @foreach($data as $row)
                                                        <tr>
                                                            ...
                                                            <td><img src="{{asset("images/amenities/$row->icon")}}" alt="Amenity Image" style="height:30px"></td>                                                    
                                                            <td>{{$row->status}}</td>                                                       
                                                            <td class="text-center">
                                                                <a href="{{url( 'admin/edit_amenity/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Edit Amenity">
                                                                    <i class="icofont icofont-edit"></i>
                                                                </a>
                                                                &nbsp;
                                                                <button data-id="{{ $row->id }}" class="btn btn-xs btn-danger delete-btn" aria-label="Delete Amenity">
