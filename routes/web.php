...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::post('/ajax/forgot-password', 'Auth\ForgotPasswordController@forgotPassword')->name('ajax.forgotPassword');
    ...
    Route::post('/ajax/dashboard/generateapikeys', 'Front\DashboardController@generateapikeys')->name('generateapikeys');
    Route::get('/ajax/dashboard/getapikeys', 'Front\DashboardController@getapikeys')->name('getapikeys');
    Route::get('/ajax/dashboard/getverifycation', 'Front\DashboardController@getverifycation')->name('getverifycation');
 ...
 Route::get('/ajax/rooms/manage-listing/{id}/get_unavailable_calendar', 'Front\CalendarController@get_unavailable_calendar');
    ...
    Route::post('/ajax/blog/post/comment', 'Front\PostController@comment')->name('blog.comment');
    Route::post('/ajax/blog/post/comment/reply', 'Front\PostController@commentreply')->name('blog.commentreply');
...
Route::get('/ajax/getfooterpages', 'HomeController@getfooterpages');
...
Route::get('/blog', '\Front\PostController@indexView');
Route::get('/blog/{id}','Front\PostController@blogView');
...
Route::get('/legal/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/rentals/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/city/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/discover/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/hosting/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/destinations/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/site-info/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/support/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/company/{slug}',  'Front\PagesController@showLegalPage');
Route::get('/about-us/{slug}',  'Front\PagesController@showLegalPage');
...
Route::get('/{address_url}/{room_id}', function($address_url, $room_id){
    $url = "/homes/$address_url/$room_id";
