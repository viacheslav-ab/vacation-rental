                        ...
                        <div class="card-block">
                           <form method="POST" action="{{url('admin/edit_review/' . $review->id)}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control" value="{{$review->reservation_id}}" aria-label="Reservation Id" disabled>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label class="col-sm-3 col-form-label text-right">Room Name</label>
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control" value="{{$review->getRoomName()}}" aria-label="Room Name" disabled>
                                 </div>
                              </div>                            
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control" value="{{$review->getUserFromName()}}" aria-label="User From" disabled>
                                 </div>
                              </div>                            
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control" value="{{$review->getUserToName()}}" aria-label="User To" disabled>
                                 </div>
                              </div>                            
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control" value="{{$review->review_by}}" aria-label="Review By" disabled>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <textarea type="text" name="comments" class="form-control" aria-label="Comments">{{$review->comments}}</textarea>
                                 </div>
                              </div>    
