                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_coupon_code')}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="0.00" name="amount" type="number" value="" step="0.01" aria-label="Description">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row" id="duration_in_months_div" style="display:none;">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control required" placeholder="Duration In Months" id="duration_in_months" min="0" max="12" value="0" name="duration_in_months"  type="number" aria-label="Expire Date" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="dropper-default" name="expired_at" class="form-control required" type="text" placeholder="Select your date" aria-label="Expire Date" required />
                                            </div>
                                        </div>
