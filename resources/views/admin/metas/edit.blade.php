                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_meta/'.$meta->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="title" class="form-control" value="{{$meta->title}}"  placeholder="Meta Title" aria-label="Meta Title" required>
                                            </div>
                                        </div>   
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">H1 Tag<span class="text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="text" name="meta_h1" value="{{$meta->meta_h1}}" class="form-control"  placeholder="H1 Tag" aria-label="H1 Tag" required>
                                            </div>
                                        </div>   
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">Meta Description<span class="text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <textarea type="text" name="description" class="form-control"  placeholder="Meta Description" aria-label="Meta Description" required>{{$meta->description}}</textarea>
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea type="text" name="keywords" class="form-control"  placeholder="Keywords" aria-label="Keywords" required>{{$meta->keywords}}</textarea>
                                            </div>
                                        </div>             
