...
class Picker extends React.PureComponent {
  ...
  render() {
    ...
    console.log(showValue, "Track on calendar picker")
    const calendar = (
      <RangeCalendar
          ...
          () => {
            return (
              <input
                ...
                type="text"
                name={props.name}
                value={showValue && showValue.format(fullFormat) && showValue.format(fullFormat) != "Invalid date" ? showValue.format(fullFormat) : ''}
              />
            );
          }
        }
...
class Search extends React.PureComponent {
  ...
  handlePageClick(data) {
    ...
    axios.post('/ajax/searchResult?page=' + new_page, {
      ...
      bedrooms: 0,
      beds: 0,
      checkin: page_data.checkin.format(fullFormat) !="Invalid date" ? page_data.checkin.format(fullFormat) : "" ,
      checkout: page_data.checkout.format(fullFormat) != "Invalid date" ? page_data.checkout.format(fullFormat) : "",
  ...
  handleSearch() {
    ...
    axios.post('/ajax/searchResult', {
      ...
      bedrooms: 0,
      beds: 0,
      checkin: page_data.checkin && page_data.checkin.format(fullFormat) !="Invalid date" ? page_data.checkin.format(fullFormat) : "" ,
      checkout: page_data.checkout && page_data.checkout.format(fullFormat) != "Invalid date" ? page_data.checkout.format(fullFormat) : "",
      guest: page_data.guest,
      instant_book: "0",
      location: this.state.searchOption == 'address' ? page_data.meta_title : this.state.location,
      map_details: "",
  ...
  componentDidMount() {
    ...
    axios.post('/ajax/searchIndex', {
      ...
      .then(res => {
        res.data.checkin =  res.data.checkin ? moment(res.data.checkin) : null
        res.data.checkout = res.data.checkout ? moment(res.data.checkout) : null
        this.setState({
          page_data: res.data
        })
        this.handleSearch()
  ...
  render() {
      console.log(this.state.page_data.checkin , 'In Render Section', this.state.map_view_mode)
              ...
              <div className="row">
                ...
                <div className="col-md-3  col-sm-6">
                  <div className="field-wrapper">
                    ...
                    {document.body.clientWidth > 550 ? (
                    this.state.page_data.checkin != null ? 
                    <Picker
                      onOpenChange={this.onStartOpenChange}
                      type="start"
                      showValue={this.state.page_data.checkin ? (this.state.page_data.checkin) : null}
                      open={this.state.startOpen}
                      value={ this.state.page_data.checkin ? [this.state.page_data.checkin ? (this.state.page_data.checkin) : today, this.state.page_data.checkout ? (this.state.page_data.checkout) : today] : null}
                ...
                <div className="col-md-3  col-sm-6">
                  <div className="field-wrapper">
                    ...
                    {document.body.clientWidth > 550 ? (
                    this.state.page_data.checkout != null ? 
                    <Picker
