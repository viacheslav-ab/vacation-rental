                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_host_banners/'.$hostbanner->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="Host banner image"> 
                                                <!-- data-default-file="{{asset("images/host_banners/$hostbanner->image")}}" -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="title" class="form-control" value="{{$hostbanner->title}}" placeholder="Title" aria-label="Host banner Title" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea  name="description" class="form-control" placeholder="Description" aria-label="Host banner Description" required>{{$hostbanner->description}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="link_title" value="{{$hostbanner->link_title}}" class="form-control" placeholder="Link Title" aria-label="Host banner Link Title" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="link" value="{{$hostbanner->link}}" class="form-control" placeholder="Link..." aria-label="Host banner Link" required>
                                            </div>
                                        </div>      
