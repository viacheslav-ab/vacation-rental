                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_help_category/'.$helpcategory->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" value="{{$helpcategory->name}}" placeholder="name" aria-label="Help Category Name" required>
                                            </div>
                                        </div>                                          
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">Description<span class="text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <textarea type="text" name="description" class="form-control required" placeholder="Write Description..." aria-label="Help Category Description" required>
