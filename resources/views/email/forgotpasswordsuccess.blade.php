                            ...
                            <tr style="border-collapse:collapse;">
                              <td class="es-m-txt-c" align="left" style="padding:0;Margin:0;">
                                <h1
                                  ...
                                  <img src="{{ url('img/logo.png')}}" alt="image" style="width: 150px;" /></h1>
                              </td>
                            </tr>
                          </table>
                        </td>
                                      ...
                                      <table width="100%" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr style="border-collapse:collapse;">
                                          <td align="right" style="padding:0;Margin:0;">
                                            <p style="color: #fff; font-size: 13px;margin: 0;">Contact Us (417) 230-0717</p>
                                            <p
                            ...
                            <tr style="border-collapse:collapse;">
                              <td align="center" style="padding:0;Margin:0;padding-bottom:10px;">
                                <h2
                                  ...
                                  Here is your temporary password to login to your account: {{$password}}
                              </td>
                            </tr>
                            <tr style="border-collapse:collapse;">
                              <td align="left" style="padding:0;Margin:0;padding-top:15px;padding-bottom:20px;">
                                <p
                                  ...
                                  Please login and create a new password for your account.
...
<br>
  ...
  color: #178693">(417) 230-0717</strong></p>
                              </td>
                            </tr>
                            <tr style="border-collapse:collapse;">
