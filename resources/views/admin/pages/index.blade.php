                                 ...
                                 @if(count($data) != 0)
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-center">
                                          ...
                                          @endphp
                                          <a href="{{$link}}" target="_blank" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Edit">
                                             <i class="icofont icofont-eye"></i>
                                          </a>
                                          &nbsp;
                                          <a href="{{url( 'admin/edit_page/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Edit">
