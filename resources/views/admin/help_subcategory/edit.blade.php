                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_help_subcategory/'.$helpsubcategory->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" value="{{$helpsubcategory->name}}" placeholder="name" aria-label="Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="category_id" class="form-control form-control-default required" aria-label="Category" required> 
