                        ...
                        <div class="card-header table-card-header">  
                           <div class="row">
                              ...
                              <div class="col-sm-3 text-right">
                                 <span class="text-danger" aria-label="Fields">(*)Fields are Mandatory</span>
                              </div>                          
                           </div>
                        </div>
                        <div class="card-block">
                           <form method="POST" action="{{url('admin/send_email')}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                              ...
                              <div class="form-group row" id="emailaddress">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="email" name="email_address" class="form-control"  placeholder="Email address" aria-label="Email Address" required>
                                 </div>
                              </div>  
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">                                       
                                    <textarea name="message" class="summernote" aria-label="Message"></textarea>
                                 </div>             
                              </div>   

                              <div class="form-group row">
                                 <div class="col-sm-12 text-center">
                                    <button type="submit" id="createuserbtn" class="btn btn-info btn-round" aria-label="Submit">Submit</button>                                   
                                 </div>
                              </div>
                           </form>
                        </div>
