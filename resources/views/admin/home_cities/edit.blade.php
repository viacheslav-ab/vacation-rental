                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_home_city/'.$homecity->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" value="{{$homecity->name}}" class="form-control" placeholder="City Name" aria-label="City Name" required>
                                            </div>
                                        </div>                                       
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="country" class="form-control form-control-default" aria-label="Country" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="Home City Image" /> 
                                                 <!-- data-default-file="{{asset("images/home_cities/$homecity->image")}}" -->
