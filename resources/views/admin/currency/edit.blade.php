                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_currency/'.$currency->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" value="{{$currency->name}}" placeholder="name" aria-label="Name" required>
                                            </div>
                                        </div>                                          
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">Code<span class="text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="text" name="code" class="form-control" value="{{$currency->code}}" placeholder="Code" aria-label="Code" required>
                                            </div>
                                        </div>      
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="symbol" class="form-control" value="{{html_entity_decode($currency->symbol)}}" placeholder="Symbol" aria-label="Symbol" required>
                                            </div>
                                        </div>                                          
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" name="rate" class="form-control" value="{{$currency->rate}}" step="0.01" placeholder="Rate" aria-label="Rate" required>
                                            </div>
                                        </div>                                          
