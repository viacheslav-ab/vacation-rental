                                                    ...
                                                    @foreach($data as $row)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{url( 'admin/edit_category/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Edit Categoty">
                                                                    <i class="icofont icofont-edit"></i>
                                                                </a>
                                                                &nbsp;
                                                                <button data-id="{{ $row->id }}" class="btn btn-xs btn-danger delete-btn" aria-label="Delete Category">
