                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/site_settings')}}" enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal bordered" role="form" aria-label="Site Name">
                                        {{ csrf_field() }}
                                        @foreach($siteSettings as $site)
                                            @if($site->flag=="1")
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="{{$site->name}}" value="{{$site->value}}" class="form-control" aria-label="Site Name" required>
                                                    </div>
                                                </div> 
                                            @elseif($site->flag=="2")
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label text-right">{{$site->name}}<span class="text-danger">*</span></label>
                                                    <div class="col-sm-6">
                                                        <textarea type="text" style="height:200px;" name="{{$site->name}}" class="form-control" aria-label="Head Code" required>{{$site->value}}</textarea>
                                                    </div>
                                                </div>
                                            @elseif($site->flag=="3") 
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label text-right">{{$site->name}}<span class="text-danger">*</span></label>
                                                    <div class="col-sm-6">
                                                        <input type="file" name="{{$site->name}}" id="input-file-now1" class="dropify required" aria-label="Site Logo" data-default-file="{{asset("images/logos/$site->value")}}"> 
                                                        <!-- data-default-file="{{asset("images/logos/$site->value")}}" -->
                                            ...
                                            @elseif($site->flag=="4")
                                                @if($site->name=="default_home")
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select class="form-control" name="default_home" aria-label="Default Home Page">
                                                ...
                                                @elseif($site->name=="paypal_currency")
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select class="form-control" name="paypal_currency" aria-label="Currency Rate Provider">
                                                ...
                                                @elseif($site->name=="upload_driver")
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select class="form-control" name="upload_driver" aria-label="Upload Driver">
                                                ...
                                                @elseif($site->name=="currency_provider")
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select class="form-control" name="currency_provider" aria-label="Currency Provider">
                                                ...
                                                @elseif($site->name=="site_date_format")
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select class="form-control" name="site_date_format" aria-label="Site Date Format">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" name="default_currency" aria-label="Default Currency">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" name="default_language" aria-label="Default Language">
