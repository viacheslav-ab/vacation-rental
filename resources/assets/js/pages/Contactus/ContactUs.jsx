                      ...
                      <div className="con-wrapper">
                        ...
                        <ul className="cont-list-parent">
                          ...
                          <li><i className="fa fa-phone" />
                            <span><a href="tel:(417) 232-6205">417 230 0717</a></span>
                          </li>
                          <li>
                            <i className="fa fa-envelope" />
                            <span><a href="mailto:sales@vacation.rentals">sales@vacation.rentals</a></span>
                          </li>
                        </ul>
                        <ul className="social-links">
                          <li>
                            <a href="https://www.facebook.com/www.vacation.rentals/"><i className="fa fa-facebook" /></a>
                          </li>
                      
                          <li>
                            <a href="https://twitter.com/Vacarent"><i className="fa fa-twitter" /></a>
                          </li>
                          <li>
                            <a href="https://www.linkedin.com/in/vacarent"><i className="fa fa-linkedin" /></a>
                          </li>
