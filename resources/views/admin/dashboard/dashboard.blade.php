               ...
               <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                     <li class="breadcrumb-item">
                        <a href="{{route('admin.dashboard')}}" aria-label="Dashboard Home">
                  ...
                  <div class="col-md-6 col-xl-4">
                     <div class="card client-blocks dark-primary-border">
                        <div class="card-block">
                           ...
                           <hr>
                           <div class="text-center">
                              <a href="/admin/todayusers" class="small-box-footer">
                                 More info <i class="icofont icofont-rounded-double-right"></i>
                              </a>
                           </div>
                        </div>
                  ...
                  <div class="col-md-6 col-xl-4">
                     <div class="card client-blocks warning-border">
                        <div class="card-block">
                           ...
                           <ul>
                              <li>
                                 <i class="icofont icofont-building-alt text-warning"></i>
                              </li>
                           ...
                           <hr>
                           <div class="text-center">
                              <a href="/admin/todayrooms" class="small-box-footer">
                                 More info <i class="icofont icofont-rounded-double-right"></i>
                              </a>
                           </div>
                        </div>
                  ...
                  <div class="col-md-6 col-xl-4">
                     <div class="card client-blocks success-border">
                        <div class="card-block">
                           ...
                           <ul>
                              <li>
                                 <i class="icofont icofont-ui-flight text-success"></i>
                              </li>
                              <li class="text-right text-success">
