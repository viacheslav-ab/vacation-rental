...
export default class AuthorDetail extends React.PureComponent{
    ...
    render(){
      return <div className="entry-content"><div className="author-sendoff clear">
      <div className="portrait">
        <img src={this.state.author.profile_picture? this.state.author.profile_picture.src : ""} alt="Mary Fernandez" width={90} height={90} className="photo lazyloading" data-was-processed="true" />
      </div>
      <div className="au-info">
        <div className="author-byline">Published by {this.state.author.full_name}</div>
        <div className="author-about"  dangerouslySetInnerHTML={{ __html : this.state.author.about }}></div>
      </div>
    </div>
    </div>
