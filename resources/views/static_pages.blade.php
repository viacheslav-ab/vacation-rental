...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>{{ isset($page_detail->permalink->seo['meta']['title']) ? $page_detail->permalink->seo['meta']['title'] : $page_detail->name}}</title>
        <meta name="description" content="{{ substr(trim(preg_replace('/\s\s+/', ' ', strip_tags($page_detail->content))), 0, 177) }}...">
        <meta name="keywords" content="{{ isset($page_detail->permalink->seo['meta']['keywords']) ? $page_detail->permalink->seo['meta']['keywords'] : '' }}">
        ...
        <meta property="og:description" content="{{ substr(trim(preg_replace('/\s\s+/', ' ', strip_tags($page_detail->content))), 0, 177) }}...">
        ...
        <meta name="twitter:description" content="{{ substr(trim(preg_replace('/\s\s+/', ' ', strip_tags($page_detail->content))), 0, 177) }}...">
        ...
        <meta name="userType" content="{{ Auth::user()->user_type }}">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        {{-- <script src="/js/staticpages/app.js"></script> --}}
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1562849618/js/static_pages/app.js"></script>
