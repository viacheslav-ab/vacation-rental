...
<html lang="{{ app()->getLocale() }}">
    <head>
		...
		<style>
		.autocomplete-dropdown-container { z-index:99 }
		</style>
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <!-- <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1562848627/js/managelisting/app.js"></script> -->
        <script src="{{ asset('/js/managelisting/app.js').'?t=111' }}"> </script>
