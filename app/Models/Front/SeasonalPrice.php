...
class SeasonalPrice extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['status', 'room_id', 'rateId', 'strategy',  'price','start_date', 'end_date', 'notes', 'is_shared','week','month','additional_guest','guests','weekend','minimum_stay','seasonal_name'];
