                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_country')}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="short_name" class="form-control"  placeholder="Short Name" aria-label="Short Name" required>
                                            </div>
                                        </div>                                          
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="long_name" class="form-control"  placeholder="Long Name" aria-label="Long Name" required>
                                            </div>
                                        </div>                                          
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="iso3" class="form-control"  placeholder="Iso3" aria-label="Iso3" required>
                                            </div>
                                        </div>                                          
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="num_code" class="form-control"  placeholder="Num Code" aria-label="Num Code" required>
                                            </div>
                                        </div>                                          
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="phone_code" class="form-control"  placeholder="Phone Code" aria-label="Phone Code" required>
                                            </div>
                                        </div>
