                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_testimonial')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="title" class="form-control" placeholder="Title" aria-label="Testimonial Title" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="excerpt" class="form-control"  placeholder="Excerpt" aria-label="Testimonial Excerpt" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="dropper-format" name="publish_date" class="form-control required " type="text" value="{{date('Y-m-d')}}" aria-label="Testimonial Publish Date" required>
                                            </div>
                                        </div>
