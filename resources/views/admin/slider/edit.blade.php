                        ...
                        <div class="card-block">
                           <form method="POST" action="{{url('admin/edit_slider/'.$slider->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="Slider Image" />
                                    <!-- data-default-file="{{asset("images/slider/$slider->image")}}" -->
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" name="order" value="{{$slider->order}}" class="form-control" value="0" placeholder="order" aria-label="Slider Order" required>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <select name="status" class="form-control form-control-default required" aria-label="Slider Status" required>                                            
