                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_subscription_plan')}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="stripe_plan_code" class="form-control" placeholder="Stripe Plan Code" aria-label="Stripe Plan Code">
                                            </div>
                                        </div>   
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">Braintree Plan Code</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="braintree_plan_code" class="form-control" placeholder="Braintree Plan Code" aria-label="Braintree Plan Code">
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" name="trial_days" min="0" class="form-control" aria-label="Trial Days">
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 input-group">                   
                                                ...
                                                <input type="text" class="form-control" name="amount" aria-label="Amount">                                    
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">    
                                                <input type="number" class="form-control" min="1" value="1" name="days" aria-label="Billing Period">                                    
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" name="images" min="1" value="1" class="form-control" aria-label="Upload Image Limit" required>
                                            </div>
                                        </div>
