                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_our_community_banners')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="title" class="form-control"  placeholder="Title" aria-label="Community Title" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea  name="description" class="form-control" placeholder="Description" aria-label="Community Desctription" required></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="link" class="form-control" placeholder="Link..." aria-label="Community Link" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="Community Image" required />
                                            </div>
                                        </div>
