                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_coupon_code/'.$couponcode->id)}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="description" class="form-control" value="{{$couponcode->description}}" placeholder="Description" aria-label="Description" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="0.00" name="amount" value="{{$couponcode->amount}}" type="number" value="" step="0.01" aria-label="Amount">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="type" class="form-control form-control-default" aria-label="Type" required>                                        
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="duration" id="duration" class="form-control form-control-default" aria-label="Duration" required>                                       
                                        ...
                                        <div class="form-group row" id="duration_in_months_div" style="display:none;">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control required" placeholder="Duration In Months" id="duration_in_months" min="0" max="12" value="{{$couponcode->duration_in_months}}" name="duration_in_months"  type="number" aria-label="Description Month" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="dropper-default" name="expired_at" value="{{$couponcode->expired_at}}" class="form-control required" type="text" placeholder="Select your date" aria-label="Expired Date" required />
                                            </div>
                                        </div>
