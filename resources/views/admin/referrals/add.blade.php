                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="{{url('admin/add_referral')}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="user_id" id="user_id" class="form-control required" aria-label="Referrer" required>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label text-right">Referral</label>
                                        <div class="col-sm-6">
                                                <select name="friend_id" id="friend_id" class="form-control required" aria-label="Referral" required>
                                                    <option value="">Select</option>                                                
                                                    @if(count($referrals) != 0)
                                                        @foreach($referrals as $row)
                                                            <option value="{{$row->id}}">{{$row->email}} - "ID" : {{$row->id}}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="credited_amount" id="credited_amount" class="form-control" placeholder="Credited Amount" aria-label="Credited Amount" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label text-right">Status<span class="text-danger">*</span></label>
                                        <div class="col-sm-6">
                                                <select name="status" class="form-control required" aria-label="Status" required> 
                                                    <option value="">Select</option>                                           
