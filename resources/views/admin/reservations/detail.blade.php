                     ...
                     <div class="card">
                        ...
                        <div class="card-block">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <span class="form-control" style="border:unset;">{{date('M d, Y', strtotime($reservation->checkin))}}</span>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <span class="form-control" style="border:unset;">{{date('M d, Y', strtotime($reservation->checkout))}}</span>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              <label class="col-sm-4 col-form-label text-right">${{$reservation->per_night}} x {{$reservation->nights}}:</label>
                              <div class="col-sm-6">
                                 <span class="form-control" style="border:unset;">${{$reservation->subtotal}}</span>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <span class="form-control" style="border:unset;">${{$reservation->cleaning}}</span>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <span class="form-control" style="border:unset;">${{$reservation->additional_guest}}</span>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <span class="form-control" style="border:unset;">${{$reservation->total}}</span>
                              </div>
                           </div>
