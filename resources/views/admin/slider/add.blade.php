                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_slider')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="Slider Image" required />
                                            </div>
                                        </div>       
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="order" class="form-control" value="0" placeholder="order" aria-label="Sldier Order" required>
                                            </div>
                                        </div>
