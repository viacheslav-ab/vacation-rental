                                 ...
                                 @if(count($data) != 0)
                                    ...
                                    <tr>
                                       ...
                                       <td>                                
                                             ...
                                             @endphp     --}}
                                       <td>
                                          <a href="{{url( 'admin/edit_room/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Room Image">
                                             <i class="icofont icofont-edit"></i>
                                          </a>
                                       </td>    
                                       <td>
                                          <button data-id="{{ $row->id }}" class="btn btn-xs btn-danger delete-btn" aria-label="Button Room Edit">
