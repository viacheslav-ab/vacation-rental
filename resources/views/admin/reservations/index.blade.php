                                    ...
                                    @foreach($data as $row)
                                       <tr>
                                          ...
                                          <td class="text-center" style=" width:50px;">
                                             <a href="{{url( 'admin/reservation/detail/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Reservation Detail">
                                                   <i class="icofont icofont-eye"></i>
                                             </a>
                                             &nbsp;                               
                                             <a href="{{url( 'admin/reservation/conversation/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Reservation Conversation">
