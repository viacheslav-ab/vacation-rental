                                        ...
                                        @foreach($referralsettings as $ref)
                                            @if($ref->name != "currency_code")
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="{{$ref->name}}" value="{{$ref->value}}" class="form-control" aria-label="Edit" required>
                                                    </div>
                                                </div>
                                            @else                                
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="currency_code" class="form-control form-control-default required" aria-label="Currency" required>                                            
