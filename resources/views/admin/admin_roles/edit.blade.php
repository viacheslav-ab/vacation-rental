                        ...
                        <div class="card-block">
                           <form method="POST" action="{{url('admin/edit_admin_role/' . $role->id)}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" name="name" class="form-control" value="{{$role->name}}" aria-label="Name" required>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label class="col-sm-3 col-form-label text-right">Display Name<span class="text-danger" >*</span></label>
                                 <div class="col-sm-6">
                                    <input type="text" name="display_name" class="form-control" value="{{$role->display_name}}" aria-label="Display Name" required>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label class="col-sm-3 col-form-label text-right">Description<span class="text-danger">*</span></label>
                                 <div class="col-sm-6">
                                    <textarea type="text" name="description" class="form-control" aria-label="Description" required>{{$role->description}}</textarea>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9 row">
                                    @foreach($permissions as $item)
                                       ...
                                       <div class="border-checkbox-group border-checkbox-group-primary col-sm-4">
                                          <input class="border-checkbox" type="checkbox" <?php echo $flag==1?"checked":""; ?> name="permission[]" value="{{ $item->id }}" aria-label="Permission">
