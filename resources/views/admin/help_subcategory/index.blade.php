                                                    ...
                                                    @foreach($data as $row)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{url( 'admin/edit_help_subcategory/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Edit Help Subcategory">
                                                                    <i class="icofont icofont-edit"></i>
                                                                </a>
                                                                &nbsp;
                                                                <button data-id="{{ $row->id }}" class="btn btn-xs btn-danger delete-btn" aria-label="Delete Help Subcategory">
