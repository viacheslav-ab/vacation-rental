                        ...
                        <div className="full-box">
                          <ul className="nav nav-tabs fullbox-tab">
                            <li><a data-toggle="tab" href="#pending-request" className="active show">
                                ...
                                Requests and
                                Inquiries</a></li>
                            <li><a data-toggle="tab" href="#notifications" className>Notifications <span className="badge badge-pill badge-secondary">{page_data.unreadmessagecount}</span></a></li>
                              ...
                              <div className="content">
                                ...
                                {page_data.pending_reservations && 
                                  page_data.pending_reservations.map((reservation, index) =>{
                                    return  <li className="list-group-item d-flex justify-content-between align-items-center">Reservation<span className="badge badge-primary badge-pill"></span></li>
                                  }) }
                              </div>
                            </div>
