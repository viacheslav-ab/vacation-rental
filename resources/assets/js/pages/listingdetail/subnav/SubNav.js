        ...
        return(
            <div className="subnav-container hide-sm">
                ...
                <div className="page-container-responsive p-0">
                    ...
                    <li>
                        <a href="#summary" className="subnav-item" aria-selected="false"><font style={{verticalAlign: 'inherit'}}><font style={{verticalAlign: 'inherit'}}>
                            Host
                            </font></font></a>
                    </li>
                    ...
                    <li>
                        <a href="#similar-listing" className="subnav-item" aria-selected="false"><font style={{verticalAlign: 'inherit'}}><font style={{verticalAlign: 'inherit'}}>
                            Similar listings
                            </font></font></a>
                    </li>
                    </ul>
