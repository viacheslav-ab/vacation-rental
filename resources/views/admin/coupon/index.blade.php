                                                ...
                                                @if(count($data) != 0)
                                                    @foreach($data as $row)
                                                        <tr>
                                                            ...
                                                            <td>{{$row->status}}</td>
                                                            <td>
                                                                <a href="{{url( 'admin/edit_coupon_code/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit" aria-label="Edit">
                                                                    <i class="icofont icofont-edit"></i>
                                                                </a>
                                                                &nbsp;
                                                                <button data-id="{{ $row->id }}" class="btn btn-xs btn-danger delete-btn" aria-label="Edit Coupon Code">
