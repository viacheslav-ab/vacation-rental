                    ...
                    <div className="row row-table"> 
                        ...
                        <div className="col-4 col-foot">
                            <ul className="list-layout list-inline pull-right">
                                <li>
                                    <a href="/facebook" className="link-contrast footer-icon-container" target="_blank" rel="noopener">
                                        <span className="screen-reader-only">Facebook</span>
                                        <i className="icon footer-icon icon-facebook"></i> 
                                    </a>        
                                </li>
                                <li>
                                    <a href="/google_plus" className="link-contrast footer-icon-container" target="_blank" rel="noopener">
                                        <span className="screen-reader-only">Google_plus</span>
                                        <i className="icon footer-icon icon-google-plus"></i> 
                                    </a>       
                                </li>
                                <li>
                                    <a href="/twitter" className="link-contrast footer-icon-container" target="_blank" rel="noopener">
                                        <span className="screen-reader-only">Twitter</span>
                                        <i className="icon footer-icon icon-twitter"></i> 
                                    </a>      
                                </li>
                                <li> 
                                    <a href="/linkedin" className="link-contrast footer-icon-container" target="_blank" rel="noopener">
                                        <span className="screen-reader-only">Linkedin</span>
                                        <i className="icon footer-icon icon-linkedin"></i> 
                                    </a>    
                                </li>
                                <li>
                                    <a href="/pinterest" className="link-contrast footer-icon-container" target="_blank" rel="noopener">
                                        <span className="screen-reader-only">Pinterest</span>
                                        <i className="icon footer-icon icon-pinterest"></i> 
                                    </a>       
                                </li>
                                <li>
                                    <a href="/youtube" className="link-contrast footer-icon-container" target="_blank" rel="noopener">
                                        <span className="screen-reader-only">Youtube</span>
                                        <i className="icon footer-icon icon-youtube"></i> 
                                    </a>        
                                </li>
                                <li>
                                    <a href="/instagram" className="link-contrast footer-icon-container" target="_blank" rel="noopener">
