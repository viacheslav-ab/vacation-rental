                     ...
                     <div class="card-block">
                        <form method="POST" action="{{url('admin/add_admin_user')}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <input type="text" name="first_name" class="form-control" placeholder="Write First Name..." aria-label="First Name" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <label class="col-sm-3 col-form-label text-right">Last Name<span class="text-danger" >*</span></label>
                              <div class="col-sm-6">
                                 <input type="text" name="last_name" class="form-control" placeholder="Write Last Name..." aria-label="Last Name" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <label class="col-sm-3 col-form-label text-right">User Name<span class="text-danger">*</span></label>
                              <div class="col-sm-6">
                                 <input type="text" name="username" class="form-control" placeholder="Write User Name..." aria-label="User Name" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <label class="col-sm-3 col-form-label text-right">Email<span class="text-danger">*</span></label>
                              <div class="col-sm-6">
                                 <input type="email" name="email" class="form-control" placeholder="Write Email..." aria-label="Email" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <label class="col-sm-3 col-form-label text-right">Bio<span class="text-danger">*</span></label>
                              <div class="col-sm-6">
                                 <input type="text" name="bio" class="form-control" placeholder="Write Bio..." aria-label="Bio" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <label class="col-sm-3 col-form-label text-right">Password<span class="text-danger">*</span></label>
                              <div class="col-sm-6">
                                 <input type="password" name="password" class="form-control" placeholder="Write password..." aria-label="Password" required>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <select name="role" class="form-control form-control-default" aria-label="Role Type" required>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <select name="support_contact" class="form-control form-control-default" aria-label="Support Contact" required>
