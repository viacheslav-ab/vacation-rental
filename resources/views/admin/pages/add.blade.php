                           ...
                           <form method="POST" action="{{url('admin/add_page')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered row" role="form">
                              ...
                              <div class="col-sm-7">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                       <input type="text" name="excerpt" class="form-control"  placeholder="Excerpt" aria-label="Excerpt" required>
                                    </div>
                                 </div>                              
                                 <div class="form-group row">
                                       ...
                                       <div class="tab-content card-block">
                                          <div class="tab-pane active" id="general" role="tabpanel" >
                                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                   <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="Image" data-default-file="{{asset("images/pages/default.jpg")}}"/> 
                                                   <!-- data-default-file="{{asset("images/pages/default.jpg")}}" -->
                                                </div>
                                             </div>
                                             <div class="form-group row">
                                          ...
                                          <div class="tab-pane" id="seo" role="tabpanel">
                                             ...
                                             <div class="form-group row col-sm-12">
                                                ...
                                                <input type="text" name="permalink[seo][meta][title]" class="form-control">                                                    
                                             </div>
                                             <div class="form-group row col-sm-12">
                                             ...
                                             <div class="form-group row col-sm-12">
                                                ...
                                                <textarea type="text" name="permalink[seo][meta][description]" class="form-control"></textarea>                                                  
                                             </div>
                                             <div class="form-group row col-sm-12">
