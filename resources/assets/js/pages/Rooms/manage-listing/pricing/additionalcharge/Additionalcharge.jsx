...
class Additionalcharge extends React.Component {
    ...
    handleChangeTemp(e) {
        ...
        console.log(name, value, this.state.temp_data);
    }
    handleAddData() {
        ...
        let additional_charges_list = this.state.additional_data.map((additional, index) => {
            return <div className="additional_charge_row input-group mb-sm-4" key={additional.label}>
                ...
                <div className="aditionalrj">
                    <div className="col-md-4 col-sm-5 col-xs-8">
                        <div className="row">                        
                            <div className="base_pric">
                                <input type="text" name="label" className="form-control" style={{marginBottom : '10px', backgroundColor: 'transparent', color : 'black'}} onChange={(event) => this.handleChangeAdditionalData(event, index)} value={additional.label} />
                            </div>
                        </div>
                        <div className="row ">  
                            <div className="col-md-3 col-sm-5 d-md-block col-xs-8 extra-field" >
                                <label className="" style={{fontSize: '14px'}}>TAXABLE? <i rel="tooltip" className="icon icon-question" title="Set to &quot;Yes&quot; if you'd like to add tax price." /></label>       
                            </div> 
                            
                            <div className="radio-group col-xl-6 col-12 d-flex justify-content-leftr">
                                <div className="form-group row pl-2 or-2">
                                    <div className="radio radio-inline col-xl-6 col-12">
                                        <label style={{fontSize: '14px'}}>
                                            <input type="radio" name={"taxable_" + index} checked={additional.taxable === "Yes"} value="Yes" onChange={(event) => this.handleChangeAdditionalData(event, index)}/>
                                            <i className="helper"></i>Yes
                                        </label>
                                    </div>
                                    <div className="radio radio col-xl-6 col-12">
                                        <label style={{fontSize: '14px'}}>
                                            <input type="radio" name={"taxable_" + index} checked={additional.taxable !== "Yes"} value="No" onChange={(event) => this.handleChangeAdditionalData(event, index)}/>
                    ...
                    <button className="btn btn-danger remove-additional_charge" type="button" style={{top:'45px', height: '35px'}} onClick={(event) => this.handleRemoveAdditional(event, index)}><i className="fa fa-trash-o" /></button>
                        ...
                        <div className="panel-body">
                                    ...
                                    <div className="col-md-6 ">
                                        <div className='row'>
                                            <div className="col-md-12 text-center">
                                                <label className="h6"> TAXABLE? <i rel="tooltip" className="icon icon-question" title="The taxable selection of the charge." /></label>
                                            </div>                                            
                                        </div>
                                        ...
                                        <div className="form-group row justify-content-center">                                            
                                            <div className="radio radio-inline col-md-5 col-3 text-center">
                                                <label>
                                                    <input type="radio" name="taxable" value="Yes" checked={this.state.temp_data.taxable == "Yes"} onChange={this.handleChangeTemp}/>
                                                    <i className="helper"></i>Yes
                                                </label>
                                            </div>
                                            <div className="radio radio-inline col-md-5 col-3 text-center">
                                                <label>
                                                    <input type="radio" name="taxable" value="No" checked={this.state.temp_data.taxable !== "Yes"} onChange={this.handleChangeTemp}/>
                                                    <i className="helper"></i>No
                                                </label>
                                            </div>
                                        </div>                                        
                            ...
                            <div className='modal-footer'>
                                <div className="force-oneline">
                                    <button type="button" className="btn js-secondary-btn" onClick={() => this.closeEditModal() }>Cancel</button>
