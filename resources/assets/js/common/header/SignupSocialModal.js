		...
		<div>	
            ...
            <div id="tos_outside" className="row-space-top-3">
              <small className="small-font style1">
                By signing up, I agree to Vacation.Rentals's <a className="link_color" href="https://www.vacation.rentals/legal/terms-of-service" data-popup="true">Terms of Service</a>, <a className="link_color" href="https://www.vacation.rentals/legal/privacy-policy" data-popup="true">Privacy Policy</a>.
              </small>
            </div>
                </div>
        </div>
