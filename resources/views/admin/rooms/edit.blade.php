                           ...
                           <form method="POST">
                              ...
                              @if($room->hasActiveSubscription())
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" name="plan_type" aria-label="Membership">                              
                              ...
                              @if($room->hasActiveSubscription())
                                 <div class="form-group">
                                    ...
                                    <input class="form-control"  readonly value="{{ $room->subscription_start_date }}" aria-label="Subscription Start Date"/>
                                 </div>
                                 <div class="form-group">
                                    <label for="plan_type">Subscription End Date</label>
                                    <input class="form-control"  readonly value="{{ $room->subscription_end_date }}" aria-label="Subscription End Date"/>
                                 </div>
                                 <div class="form-group">
                                    <label for="plan_type">Subscription Days</label>
                                    <input class="form-control"  readonly value="{{ $room->subscription_days }}" aria-label="Subscription Days"/>
                                 </div>
                              @endif
                              <div class="form-group">
                                 <label class="">Summary<span class="text-danger">*</span></label>
                                 <div class="col-sm-9">                                       
                                    <textarea name="summary" class="summernote" aria-label="Summary">{{$room->summary}}</textarea>
                                 </div>             
                              </div>  
                              <div class="form-group">
                           ...
                           <div class="card-block">
                              <form method="POST">
                                 ...
                                 <input name="action" value="updatemembership" type="hidden"/>
                                    ...
                                    <input id="dropper-default" name="extend_date" data-dd-default-date="{{ $room->subscription_end_date}}" value="{{ $room->subscription_end_date}}" data-dd-format="Y-m-d" class="form-control required" type="text" placeholder="Select your date" aria-label="Choose Date" required />
                                    </div>
