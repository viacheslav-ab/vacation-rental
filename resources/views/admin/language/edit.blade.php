                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/edit_language/'.$language->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" value="{{$language->name}}" placeholder="name" aria-label="Name" required>
                                            </div>
                                        </div>                                          
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">Value<span class="text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="text" name="value" class="form-control" value="{{$language->value}}" placeholder="Value" aria-label="Value" required>
                                            </div>
                                        </div>                                 
