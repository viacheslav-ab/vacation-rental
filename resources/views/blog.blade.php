...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>{{ isset($post->meta_title) ? $post->meta_title : (isset($meta_data) ? $meta_data['title'] : 'Blog') }}</title>
        <meta name="description" content="{{ isset( $post->meta_description) ?  $post->meta_description : "" }}">
        <meta name="keywords" content="{{ isset($post->permalink->seo['meta']['keywords']) ? $post->permalink->seo['meta']['keywords'] : '' }}">
        ...
        <meta property="og:description" content="{{ isset( $post->meta_description) ?  $post->meta_description : "" }}">
        ...
        <meta name="twitter:description" content="{{ isset( $post->meta_description) ?  $post->meta_description : "" }}">
        ...
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1557575780/css/blog/app.css" type="text/css">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope"> 
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1562848493/js/blog/app.js"></script>
        ...
        */
        (function() { // DON'T EDIT BELOW THIS LINE
            ...
            s.src = 'https://vacation-rentals-2.disqus.com/embed.js';
