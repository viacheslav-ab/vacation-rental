                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="{{url('admin/edit_referral/' . $referral->id)}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text"  name="credited_amount" value="{{$referral->credited_amount}}" class="form-control" placeholder="Credited Amount" aria-label="Credited Amount" required>
                                            </div>
                                        </div>
