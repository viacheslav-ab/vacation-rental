...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555965360/css/search/app.css" type="text/css">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <!--<script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1562848682/js/search/app.js"></script>-->
        <script src="{{ asset('/js/search/app.js')}}"></script>
