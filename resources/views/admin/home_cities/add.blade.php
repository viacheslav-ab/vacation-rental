                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{url('admin/add_home_city')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" aria-label="City Name" placeholder="City Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="image" id="input-file-now1" class="dropify required" aria-label="City Image" required />
                                            </div>
                                        </div>  
                                        <div class="form-group row">
