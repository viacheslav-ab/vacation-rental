                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">   
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input id="from"  class="date-dropper form-control required " type="text" value="{{date('Y-m-d')}}" aria-label="From Date" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">   
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input id="to" name="publish_date" class="date-dropper form-control required " type="text" value="{{date('Y-m-d')}}" aria-label="To Date" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">   
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select id="category" class="form-control form-control-default required categories-select" aria-label="Category" required>
