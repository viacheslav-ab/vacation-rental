                                ...
                                <form method="POST" action="{{url('admin/edit_post/' . $post->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered row" role="form">
                                    ...
                                    <div class="col-sm-7">  
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="title" class="form-control" aria-label="Title" value={{$post->title}} required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="excerpt" class="form-control" value={{$post->excerpt}} aria-label="Excerpt" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">                                       
                                                <textarea name="content" class="summernote" aria-label="Content">{{$post->content}}</textarea>
                                            </div>             
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-sm-5">                                     
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <!-- data-default-file="{{asset("images/posts/$post->image")}}" -->
                                            </div>
                                        </div>
                                                ...
                                                <select name="author_id" class="categories-select form-control required" required>
                                                    <option value="">Select</option>                                            
                                                        @foreach($authores as $row)
                                                            <option role="combobox" aria-labelledby="label" value="{{$row->id}}" <?php echo $row->id==$post->author_id?"selected":""; ?>>{{$row->first_name}} {{$row->last_name}}</option>
                                                        @endforeach                                           
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="dropper-default" aria-label="Publish Date" name="publish_date" class="form-control required" type="text" value="{{date('Y-m-d', strtotime($post->publish_date))}}" required />
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="tab-pane" id="seo" role="tabpanel">
                                                        <div class="form-group row col-sm-12">
                                                            ...
                                                            <div class=" input-group">                                                        
                                                                ...
                                                                <input type="text" class="form-control"  name="permalink[slug]" value="{{ isset($post->permalink->slug) ? $post->permalink->slug : '' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row col-sm-12">
                                                            ...
                                                            <input type="text" name="permalink[seo][meta][h1_tag]" class="form-control" value="{{ isset($post->permalink->seo['meta']['h1_tag']) ? $post->permalink->seo['meta']['h1_tag'] : '' }}">                                                    
                                                        </div>
                                                        ...
                                                        <div class="form-group row col-sm-12">
                                                            ...
                                                            <input type="text" name="permalink[seo][meta][keywords]" class="form-control" value="{{ isset($post->permalink->seo['meta']['keywords'] ) ? $post->permalink->seo['meta']['keywords']  : ''}}">                                                    
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="input_permalink_robots_index" class="form-control" name="permalink[seo][advanced][robots][index]">
                                                                    <option @if(isset($post->permalink['seo']['advanced']['robots']['index']) && $post->permalink['seo']['advanced']['robots']['index'] == "-1") selected @endif value="-1" >Default</option>
                                                                    <option @if(isset($post->permalink['seo']['advanced']['robots']['index']) && $post->permalink['seo']['advanced']['robots']['index'] == "1") selected @endif value="1">Yes (index)</option>
                                                                    <option @if(isset($post->permalink['seo']['advanced']['robots']['index']) && $post->permalink['seo']['advanced']['robots']['index'] == "0") selected @endif value="0">No (no index)</option></select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="input_permalink_robots_follow" class="form-control" name="permalink[seo][advanced][robots][follow]">
                                                                    <option @if(isset($post->permalink['seo']['advanced']['robots']['follow']) && $post->permalink['seo']['advanced']['robots']['follow'] == "1") selected @endif value="1">Follow</option>
                                                                    <option @if(isset($post->permalink['seo']['advanced']['robots']['follow']) && $post->permalink['seo']['advanced']['robots']['follow'] == "0") selected @endif value="0">No follow</option>
                                                                </select>
                                                                <span class="text-danger"></span>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <span class="switch">
                                                                        <input @if(isset($post->permalink['seo']['advanced']['robots']['noimageindex']) && $post->permalink['seo']['advanced']['robots']['noimageindex'] ) checked @endif class="switch1" id="image-index-checkbox"  name="permalink[seo][advanced][robots][noimageindex]" type="checkbox">
                                                                ...
                                                                <div class="form-group">
                                                                    <span class="switch">
                                                                        ...
                                                                        @if(isset($post->permalink['seo']['advanced']['robots']['noarchive']) && $post->permalink['seo']['advanced']['robots']['noarchive']  ) checked @endif
                                                                        type="checkbox">
                                                                ...
                                                                <div class="form-group">
                                                                    <span class="switch">
                                                                        ...
                                                                        @if(isset($post->permalink['seo']['advanced']['robots']['nosnippet']) && $post->permalink['seo']['advanced']['robots']['nosnippet'] ) checked @endif
                                                                        type="checkbox">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="input_canonical_url" name="permalink[seo][advanced][canonical]"
                                                                value="{{ isset($post->permalink['seo']['advanced']['canonical']) ? $post->permalink['seo']['advanced']['canonical'] : '' }}" type="text">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>                                           
