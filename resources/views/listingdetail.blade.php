...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <!-- <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1563894601/js/listingdetail/app.js"></script> -->
        <script src="{{ asset('/js/ListingDetail/app.js').'?t=111' }}"></script>
