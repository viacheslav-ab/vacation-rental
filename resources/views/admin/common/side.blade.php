<nav class="pcoded-navbar" pcoded-header-position="relative">
    <div class="sidebar_toggle">
        <a href="#" aria-label="Dashboard Menu">
    ...
    <div class="pcoded-inner-navbar main-menu">
        <ul class="pcoded-item pcoded-left-item">              
            <li class="{{ (Route::is('admin.dashboard') ? 'active' : '') }}">
                <a href="{{route('admin.dashboard')}}" aria-label="Home" data-i18n="nav.form-select.main" >
            ...
            <li class="pcoded-hasmenu {{ ((Route::is('admin.admin.users') || Route::is('admin.admin.roles')) ? 'active' : '' ) }}">
                <a href="javascript:void(0)" data-i18n="nav.navigate.main" aria-label="Dashboard">
            ...
            <li class="pcoded-hasmenu {{ ((Route::is('admin.users') || Route::is('admin.todayusers')) ? 'active' : '' ) }}">
                <a href="javascript:void(0)" data-i18n="nav.navigate.main" aria-label="Dashboard">
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="{{route('admin.users')}}" data-i18n="nav.navigate.navbar">
                            <span class="pcoded-micon"><i class="icofont icofont-ui-user-group"></i></span>
                            <span class="pcoded-mtext">Manage Users</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                        ...
                        <li class=" "> 
                        <a href="{{route('admin.todayusers')}}" data-i18n="nav.navigate.navbar-inverse">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">Manage Today Users</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>                    
                </ul>
            ...
            <li class="pcoded-hasmenu {{ ((Route::is('admin.rooms') || Route::is('admin.rooms_tags') || Route::is('admin.todayrooms')) ? 'active' : '' ) }}">
                <a href="javascript:void(0)" data-i18n="nav.navigate.main" aria-label="Dashboard">
                ...
                <ul class="pcoded-submenu">
                        ...
                        <li class=" "> 
                            <a href="{{route('admin.todayrooms')}}" data-i18n="nav.navigate.navbar-inverse">
                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                <span class="pcoded-mtext">Manage Today Rooms</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>  
            ...
            <li class="{{ (Route::is('admin.reservations') ? 'active' : '') }}">
                <a href="{{route('admin.reservations')}}" data-i18n="nav.form-select.main" aria-label="reservations">
            ...
            <li class="pcoded-hasmenu {{ ((Route::is('admin.reservations') || Route::is('admin.todayreservations')) ? 'active' : '' ) }}">
                <a href="javascript:void(0)" data-i18n="nav.navigate.main" aria-label="Dashboard">
                    <span class="pcoded-micon"><i class="icofont icofont-ui-flight"></i></span>
                    <span class="pcoded-mtext">Manage Reservations</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="{{route('admin.reservations')}}" data-i18n="nav.navigate.navbar">
                            <span class="pcoded-micon"><i class="icofont icofont-ui-user-group"></i></span>
                            <span class="pcoded-mtext">Manage Reservations</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    ...
                    <li class=" "> 
                        <a href="{{route('admin.todayreservations')}}" data-i18n="nav.navigate.navbar-inverse">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">Manage Today Reservations</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>                    
                </ul>
            ...
            <li class="{{ (Route::is('admin.reviews') ? 'active' : '') }}">
                <a href="{{route('admin.reviews')}}" data-i18n="nav.form-select.main" aria-label="reviews">
            ...
            <li class="{{ (Route::is('admin.referrals') ? 'active' : '') }}">
                <a href="{{route('admin.referrals')}}" data-i18n="nav.form-select.main" aria-label="referrals">
            ...
            <li  class="{{ (Route::is('admin.wishlists') ? 'active' : '') }}">
                <a href="{{route('admin.wishlists')}}" data-i18n="nav.form-select.main" aria-label="wishlists">
            ...
            <li  class="{{ (Route::is('admin.coupon') ? 'active' : '') }}">
                <a href="{{route('admin.coupon')}}" data-i18n="nav.form-select.main" aria-label="coupon">
            ...
            <li  class="{{ (Route::is('admin.reports') ? 'active' : '') }}">
                <a href="{{route('admin.reports')}}" data-i18n="nav.form-select.main" aria-label="reports">
            ...
            <li  class="{{ (Route::is('admin.home_cities') ? 'active' : '') }}">
                <a href="{{route('admin.home_cities')}}" data-i18n="nav.form-select.main" aria-label="home cities">
            ...
            <li  class="{{ (Route::is('admin.slider') ? 'active' : '') }}">
                <a href="{{route('admin.slider')}}" data-i18n="nav.form-select.main" aria-label="slider">
            ...
            <li  class="{{ (Route::is('admin.bottom_slider') ? 'active' : '') }}">
                <a href="{{route('admin.bottom_slider')}}" data-i18n="nav.form-select.main" aria-label="bottom slider">
                    <span class="pcoded-micon"><i class="icofont icofont-ui-image"></i></span>
            ...
            <li class="{{ (Route::is('admin.testimonials') ? 'active' : '') }}">
                <a href="{{route('admin.testimonials')}}" data-i18n="nav.form-select.main" aria-label="testimonials">
                    <span class="pcoded-micon"><i class="icofont icofont-ui-v-card"></i></span>
            ...
            <li class="{{ (Route::is('admin.our_community_banners') ? 'active' : '') }}">
                <a href="{{route('admin.our_community_banners')}}" data-i18n="nav.form-select.main" aria-label="our community banners">
                    <span class="pcoded-micon"><i class="icofont icofont-ui-image"></i></span>
            ...
            <li class="{{ (Route::is('admin.host_banners') ? 'active' : '') }}">
                <a href="{{route('admin.host_banners')}}" data-i18n="nav.form-select.main" aria-label="host banners">
                    <span class="pcoded-micon"><i class="icofont icofont-ui-image"></i></span>
            ...
            <li class="{{ (Route::is('admin.property_manager') ? 'active' : '') }}">
                <a href="{{route('admin.property_manager')}}" data-i18n="nav.form-select.main" aria-label="property manager">
            ...
            <li class="{{ (Route::is('admin.property_type') ? 'active' : '') }}">
                <a href="{{route('admin.property_type')}}" data-i18n="nav.form-select.main" aria-label="property type">
                    <span class="pcoded-micon"><i class="icofont icofont-building"></i></span>
            ...
            <li class="{{ (Route::is('admin.room_type') ? 'active' : '') }}">
                <a href="{{route('admin.room_type')}}" data-i18n="nav.form-select.main" aria-label="room type">
            ...
            <li class="{{ (Route::is('admin.bed_type') ? 'active' : '') }}">
                <a href="{{route('admin.bed_type')}}" data-i18n="nav.form-select.main" aria-label="bed type">
            ...
            <li class="{{ (Route::is('admin.currency') ? 'active' : '') }}">
                <a href="{{route('admin.currency')}}" data-i18n="nav.form-select.main" aria-label="currency">
            ...
            <li class="{{ (Route::is('admin.language') ? 'active' : '') }}">
                <a href="{{route('admin.language')}}" data-i18n="nav.form-select.main" aria-label="language">
            ...
            <li class="{{ (Route::is('admin.country') ? 'active' : '') }}">
                <a href="{{route('admin.country')}}" data-i18n="nav.form-select.main" aria-label="country">
            ...
            <li class="{{ (Route::is('admin.referral_settings') ? 'active' : '') }}">
                <a href="{{route('admin.referral_settings')}}" data-i18n="nav.form-select.main" aria-label="referral settings">
                    <span class="pcoded-micon"><i class="icofont icofont-ui-user-group"></i></span>
            ...
            <li class="{{ (Route::is('admin.fees') ? 'active' : '') }}">
                <a href="{{route('admin.fees')}}" data-i18n="nav.form-select.main" aria-label="fees">
                    <span class="pcoded-micon"><i class="icofont icofont-cur-dollar"></i></span>
            ...
            <li class="{{ (Route::is('admin.metas') ? 'active' : '') }}">
                <a href="{{route('admin.metas')}}" data-i18n="nav.form-select.main" aria-label="metas">
            ...
            <li class="{{ (Route::is('admin.api_credentials') ? 'active' : '') }}">
                <a href="{{route('admin.api_credentials')}}" data-i18n="nav.form-select.main" aria-label="api credentials">
                    <span class="pcoded-micon"><i class="icofont icofont-chart-bar-graph"></i></span>
            ...
            <li class="{{ (Route::is('admin.payment_gateway') ? 'active' : '') }}">
                <a href="{{route('admin.payment_gateway')}}" data-i18n="nav.form-select.main" aria-label="payment gateway">
            ...
            <li class="{{ (Route::is('admin.join_us') ? 'active' : '') }}">
                <a href="{{route('admin.join_us')}}" data-i18n="nav.form-select.main" aria-label="join us">
            ...
            <li class="{{ (Route::is('admin.theme_settings') ? 'active' : '') }}">
                <a href="{{route('admin.theme_settings')}}" data-i18n="nav.form-select.main" aria-label="theme settings">
            ...
            <li class="{{ (Route::is('admin.site_settings') ? 'active' : '') }}">
                <a href="{{route('admin.site_settings')}}" data-i18n="nav.form-select.main" aria-label="site settings">
