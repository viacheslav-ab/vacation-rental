...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="{{asset('admin_assets/assets/css/admin_login.css')}}">
   </head>
                     ...
                     <form id="sign_in_adm" method="POST" action="{{ route('admin.login.submit') }}" class="md-float-material">
                        ...
                        <div class="auth-box">
                           ...
                           <div class="input-group"> 
                              <input type="email" class="form-control border-radius-30px" name="email" placeholder="Email Address" value="{{ old('email') }}" required autofocus aria-label="Email Address">
                           ...
                           <div class="input-group">
                              <input type="password" class="form-control border-radius-30px" name="password" placeholder="Password" required aria-label="Password">
                              <span class="md-line"></span>
                           </div>
                           <div>
