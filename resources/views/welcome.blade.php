...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="keywords" content="vacation, rentals, vacation rentals, property manager">
        ...
        <meta property="og:image" content="https://www.vacation.rentals/images/logo/vr_logo_icon_text.png">
        ...
        <meta name="twitter:image" content="https://www.vacation.rentals/images/logo/vr_logo_icon_text.png">
        ...
        <link rel="icon" href="https://res.cloudinary.com/vacation-rentals/image/upload/v1553980443/images/vr-icon-white.png" type="image/x-icon">
        <!-- Fonts -->
        <meta name="google-site-verification" content="Vk_PCTto97HA-jpkN3taEi7LgPle_M4pTgye-Y-S_84" />
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1556551108/css/home/app.css" type="text/css">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA34nBk3rPJKXaNQaSX4YiLFoabX3DhkXs&libraries=places"></script>
        ...
        <!-- <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1562848410/js/app.js"></script> -->
        <script src="{{ asset('js/app.js').'?t=111' }}"> </script>
