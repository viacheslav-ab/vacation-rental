...
class Booking extends React.Component {
    ...
    componentDidMount(){
      axios.get(`/ajax/rooms/manage-listing/${this.props.room_id}/get_unavailable_calendar`)
      .then(Response =>{
          this.setState({
      ...
      axios.get(`/ba/account/get_ba_credential`)
      .then(Response =>{
          console.log(Response.data.data.is_bin_enable)
          this.setState({
              is_bin_enable:Response.data.data.is_bin_enable
          })
      })
    }
    openChatModal(){
      ...
      onSelectDateRange (value, states)  {
        this.setState({ value, states }, () =>{
          this.setState({
            ...
            axios.post('/ajax/rooms/price_calculation', {checkin : this.state.value.start, checkout : this.state.value.end, guest_count : this.state.number_of_guests, room_id : this.props.room_id})
            .then(result => {
                this.setState({
                    price_result : result.data,
                    is_pricing : false
    ...
    render(){
      ...
      let dateRanges = []
      dateRanges = this.state.calendar_data.map((calendar, index) =>{
        return {
                                        ...
                                        <div className="col-md-9 col-sm-12 lang-chang-label">
                                            <div className="row row-condensed">
                                                <div className="col-sm-6 space-1-sm lang-chang-label">
                                                    ...
                                                    <input className="checkin ui-datepicker-target hasDatepicker w-100" name='checkin' placeholder="Check In" readOnly  id="checkin" value={this.state.checkin ? this.state.checkin.format("MM-DD-YYYY") : ""} required onClick={this.onToggleCalendarOpen}/>
                                                    {/* <Picker
                                                        ...
                                                        className="checkin ui-datepicker-target hasDatepicker w-100" placeholder="Check In"
                                                        />
                                                ...
                                                <div className="col-sm-6 space-1-sm">
                                                    <label htmlFor="checkout"><font style={{verticalAlign: 'inherit'}}><font style={{verticalAlign: 'inherit'}}>
                                                        ...
                                                        <input className="checkin ui-datepicker-target hasDatepicker w-100" name='checkout' placeholder="Check Out" readOnly id="checkout" value={this.state.checkout ? this.state.checkout.format("MM-DD-YYYY") : ""} required onClick={this.onToggleCalendarOpen}/>
                                                        {/* <Picker
                                                            ...
                                                            onChange={this.onEndChange}
                                                             ...
                                                             readOnly="readonly" className="checkout ui-datepicker-target hasDatepicker" placeholder="Check Out"
                                                            /> */}
                                                     
                                                </div>
                                                {this.state.isRangeCalendaropen && (<div className="datepickerOverlay" onClick={() => this.setState({isRangeCalendaropen : false})}></div>)}
                                    ...
                                    <div className="js-book-it-enabled clearfix">
                                       ...
                                       {this.state.price_result.status && this.state.price_result.status == 'Not available'  ? this.state.price_result.error : null}
                                        ...
                                        {this.state.is_bin_enable ? 
                                          (<div className="js-book-it-btn-container row-space-top-2 ">
                                              <button type="button" id="request_book_btn" className="js-book-it-btn btn btn-large btn-block btn-success" onClick={this.RequestBook}>
                                              <span className="book-it__btn-text "><font style={{verticalAlign: 'inherit'}}><font style={{verticalAlign: 'inherit'}}>
                                                      Book it now
                                                  </font></font></span>
                                              </button>
